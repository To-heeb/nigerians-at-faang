<!-- Favicons -->
{{-- <link href="{{ cdn_asset('assets/img/favicon.ico') }}" rel="icon"> --}}
...
{{-- <link href="{{ cdn_asset('assets/img/favicon/favicon-img.jpeg') }}" rel="icon"> --}}
{{-- <link href="{{ cdn_asset('assets/img/favicon/favicon-img.jpeg') }}" rel="apple-touch-icon"> --}}
